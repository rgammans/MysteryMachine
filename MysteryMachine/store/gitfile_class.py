...
"""
A pacakge to contain the filestore engine used by Version 1 of the pack
...
from MysteryMachine.store.gitfile_base import GitStoreMixin

class GitFileStore(GitStoreMixin,filestore):
    uriScheme = "gitafile"
